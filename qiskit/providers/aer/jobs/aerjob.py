...
class AerJob(Job):
    ...
    def circuits(self):
        """Return the List of QuantumCircuits submitted for this job.

        Returns:
            circuits: List of QuantumCircuits submitted for this job.
        """
        return self._qobj

    def configuration(self):
        """Return the Configuration submitted for this job.
