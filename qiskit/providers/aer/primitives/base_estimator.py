...
class BaseEstimator(ABC):
    ...
    def __init__(
        ...
        """
        Creating an instance of an Estimator, or using one in a ``with`` context opens a session
        that holds resources until the instance is ``close()`` ed or the context is exited.
    ...
    def __call__(
        ...
        **run_options,
        ...
        try:
            ...
            raise QiskitError(
                "The observables passed when calling estimator is not one of the observables used "
