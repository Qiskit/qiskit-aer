...
PYBIND11_MODULE(controller_wrappers, m) {
    ...
    m.def("qasm_controller_execute_result", [](const py::object &qobj) -> AER::Result {
        return AER::controller_execute_result<AER::Simulator::QasmController>(qobj);
    });
    ...
    m.def("statevector_controller_execute_result", [](const py::object &qobj) -> AER::Result {
        return AER::controller_execute_result<AER::Simulator::StatevectorController>(qobj);
    });
    ...
    m.def("unitary_controller_execute_result", [](const py::object &qobj) -> AER::Result {
        return AER::controller_execute_result<AER::Simulator::UnitaryController>(qobj);
    });
