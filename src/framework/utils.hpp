...
template <typename T>
std::map<std::string, T> vec2ket(const AER::Vector<T> &vec, double epsilon, uint_t base = 2);
...
template <typename T>
std::map<std::string, T> vec2ket(const AER::Vector<T> &vec, double epsilon, uint_t base) {
