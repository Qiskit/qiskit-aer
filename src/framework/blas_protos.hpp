...
void cpteqr_(const char *compz, const size_t *n, float *d, float *e, std::complex<float>* z, size_t *ldz, float* work, int *info );
void zpteqr_(const char *compz, const size_t *n, double *d, double *e, std::complex<double>* z, size_t *ldz, double* work, int *info );
