...
inline Op make_cx(uint_t ctrl_qubit, uint_t tgt_qubit) {
  Op op;
  op.type = OpType::gate;
  op.name = "cx";
...
inline Op make_cz(uint_t ctrl_qubit, uint_t tgt_qubit) {
  Op op;
  op.type = OpType::gate;
  op.name = "cz";
  op.qubits = {ctrl_qubit, tgt_qubit};
...
inline Op make_cy(uint_t ctrl_qubit, uint_t tgt_qubit) {
  Op op;
  op.type = OpType::gate;
  op.name = "cy";
  op.qubits = {ctrl_qubit, tgt_qubit};
...
template <typename T> // real or complex numeric type
inline Op make_cp(uint_t ctrl_qubit, uint_t tgt_qubit, T theta) {
  Op op;
  op.type = OpType::gate;
  op.name = "cp";
  op.qubits = {ctrl_qubit, tgt_qubit};
...
template <typename T> // real or complex numeric type
inline Op make_cu1(uint_t ctrl_qubit, uint_t qubit, T theta) {
  Op op;
  op.type = OpType::gate;
  op.name = "cu1";
...
template <typename T> // real or complex numeric type
inline Op make_cu2(uint_t ctrl_qubit, uint_t qubit, T phi, T lam) {
  Op op;
  op.type = OpType::gate;
  op.name = "cu2";
  op.qubits = {ctrl_qubit, qubit};
...
template <typename T> // real or complex numeric type
inline Op make_cu3(uint_t ctrl_qubit, uint_t qubit, T theta, T phi, T lam) {
  Op op;
  op.type = OpType::gate;
  op.name = "cu3";
  op.qubits = {ctrl_qubit, qubit};
...
inline Op make_swap(uint_t qubit1, uint_t qubit2) {
  Op op;
  op.type = OpType::gate;
  op.name = "swap";
...
inline Op make_id(uint_t qubit) {
  Op op;
  op.type = OpType::gate;
  op.name = "id";
  op.qubits = {qubit};
...
template <typename T> // real or complex numeric type
inline Op make_p(uint_t qubit, T theta) {
  Op op;
  op.type = OpType::gate;
  op.name = "p";
  op.qubits = {qubit};
...
inline Op make_sdg(uint_t qubit) {
  Op op;
  op.type = OpType::gate;
  op.name = "sdg";
  op.qubits = {qubit};
...
inline Op make_tdg(uint_t qubit) {
  Op op;
  op.type = OpType::gate;
  op.name = "tdg";
  op.qubits = {qubit};
...
template <typename T> // real or complex numeric type
inline Op make_r(uint_t qubit, T theta, T phi) {
  Op op;
  op.type = OpType::gate;
  op.name = "r";
  op.qubits = {qubit};
...
template <typename T> // real or complex numeric type
inline Op make_rx(uint_t qubit, T theta) {
  Op op;
  op.type = OpType::gate;
  op.name = "rx";
  op.qubits = {qubit};
...
template <typename T> // real or complex numeric type
inline Op make_ry(uint_t qubit, T theta) {
  Op op;
  op.type = OpType::gate;
  op.name = "ry";
  op.qubits = {qubit};
...
template <typename T> // real or complex numeric type
inline Op make_rz(uint_t qubit, T phi) {
  Op op;
  op.type = OpType::gate;
  op.name = "rz";
  op.qubits = {qubit};
...
template <typename T> // real or complex numeric type
inline Op make_rxx(uint_t qubit1, uint_t qubit2, T theta) {
  Op op;
  op.type = OpType::gate;
  op.name = "rxx";
  op.qubits = {qubit1, qubit2};
...
template <typename T> // real or complex numeric type
inline Op make_ryy(uint_t qubit1, uint_t qubit2, T theta) {
  Op op;
  op.type = OpType::gate;
  op.name = "ryy";
  op.qubits = {qubit1, qubit2};
...
template <typename T> // real or complex numeric type
inline Op make_rzz(uint_t qubit1, uint_t qubit2, T theta) {
  Op op;
  op.type = OpType::gate;
  op.name = "rzz";
  op.qubits = {qubit1, qubit2};
...
template <typename T> // real or complex numeric type
inline Op make_rzx(uint_t qubit1, uint_t qubit2, T theta) {
  Op op;
  op.type = OpType::gate;
  op.name = "rzx";
  op.qubits = {qubit1, qubit2};
...
inline Op make_ccx(uint_t control_qubit1, uint_t control_qubit2, uint_t target_qubit) {
  Op op;
  op.type = OpType::gate;
  op.name = "ccx";
...
inline Op make_cswap(uint_t control_qubit, uint_t target_qubit1, uint_t target_qubit2) {
  Op op;
  op.type = OpType::gate;
  op.name = "cswap";
...
inline Op make_mcx(const reg_t& control_qubits, uint_t target_qubit) {
  Op op;
  op.type = OpType::gate;
  op.name = "mcx";
  op.qubits = control_qubits;
...
inline Op make_mcy(const reg_t& control_qubits, uint_t target_qubit) {
  Op op;
  op.type = OpType::gate;
  op.name = "mcy";
  op.qubits = control_qubits; op.qubits.push_back(target_qubit);
  //op.params = {};
  op.string_params = {op.name};
  return op;
}

inline Op make_mcz(const reg_t& control_qubits, uint_t target_qubit) {
  Op op;
  op.type = OpType::gate;
  op.name = "mcz";
  op.qubits = control_qubits; op.qubits.push_back(target_qubit);
...
template <typename T> // real or complex numeric type
inline Op make_mcu1(const reg_t& control_qubits, uint_t target_qubit, T lam) {
  Op op;
  op.type = OpType::gate;
  op.name = "mcu1";
  op.qubits = control_qubits; op.qubits.push_back(target_qubit);
...
template <typename T> // real or complex numeric type
inline Op make_mcu2(const reg_t& control_qubits, uint_t target_qubit, T phi, T lam) {
  Op op;
  op.type = OpType::gate;
  op.name = "mcu2";
  op.qubits = control_qubits; op.qubits.push_back(target_qubit);
...
template <typename T> // real or complex numeric type
inline Op make_mcu3(const reg_t& control_qubits, uint_t target_qubit, T theta, T phi, T lam) {
  Op op;
  op.type = OpType::gate;
  op.name = "mcu3";
  op.qubits = control_qubits; op.qubits.push_back(target_qubit);
...
inline Op make_mcswap(const reg_t& control_qubits, uint_t target_qubit1, uint_t target_qubit2) {
  Op op;
  op.type = OpType::gate;
  op.name = "mcswap";
  op.qubits = control_qubits; op.qubits.push_back(target_qubit1); op.qubits.push_back(target_qubit2);
  //op.params = {};
  op.string_params = {op.name};
  return op;
}

inline Op make_mcphase(const reg_t& control_qubits, uint_t target_qubit) {
  Op op;
  op.type = OpType::gate;
  op.name = "mcphase";
  op.qubits = control_qubits; op.qubits.push_back(target_qubit);
...
template <typename T> // real or complex numeric type
inline Op make_mcr(const reg_t& control_qubits, uint_t target_qubit, T theta, T phi) {
  Op op;
  op.type = OpType::gate;
  op.name = "mcr";
  op.qubits = control_qubits; op.qubits.push_back(target_qubit);
...
template <typename T> // real or complex numeric type
inline Op make_mcrx(const reg_t& control_qubits, uint_t target_qubit, T theta) {
  Op op;
  op.type = OpType::gate;
  op.name = "mcrx";
  op.qubits = control_qubits; op.qubits.push_back(target_qubit);
...
template <typename T> // real or complex numeric type
inline Op make_mcry(const reg_t& control_qubits, uint_t target_qubit, T theta) {
  Op op;
  op.type = OpType::gate;
  op.name = "mcry";
  op.qubits = control_qubits; op.qubits.push_back(target_qubit);
...
inline Op make_sx(uint_t qubit) {
  Op op;
  op.type = OpType::gate;
  op.name = "sx";
  op.qubits = {qubit};
...
inline Op make_csx(uint_t control_qubit, uint_t target_qubit) {
  Op op;
  op.type = OpType::gate;
  op.name = "csx";
...
inline Op make_mcsx(const reg_t& control_qubits, uint_t target_qubit) {
  Op op;
  op.type = OpType::gate;
  op.name = "mcsx";
  op.qubits = control_qubits; op.qubits.push_back(target_qubit);
...
inline Op make_delay(uint_t qubit) {
  Op op;
  op.type = OpType::gate;
  op.name = "delay";
  op.qubits = {qubit};
...
inline Op make_pauli(const reg_t& qubits, std::string pauli_string) {
  Op op;
  op.type = OpType::gate;
  op.name = "pauli";
  op.qubits = qubits;
...
inline Op make_mcx_gray(const reg_t& control_qubits, uint_t target_qubit) {
  Op op;
  op.type = OpType::gate;
  op.name = "mcx_gray";
  op.qubits = control_qubits; op.qubits.push_back(target_qubit);
