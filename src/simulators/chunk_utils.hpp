...
void get_qubits_inout(const int chunk_qubits, const reg_t& qubits, reg_t& qubits_in,reg_t& qubits_out)
{
  int_t i;
  qubits_in.clear();
  qubits_out.clear();
...
void get_inout_ctrl_qubits(const Operations::Op &op, const uint_t num_qubits, reg_t& qubits_in, reg_t& qubits_out)
{
...
Operations::Op correct_gate_op_in_chunk(const Operations::Op &op, reg_t& qubits_in)
{
...
void block_diagonal_matrix(const uint_t gid, const uint_t chunk_bits, reg_t &qubits, cvector_t &diag)
{
  uint_t i;
  uint_t mask_out = 0;
  uint_t mask_id = 0;
