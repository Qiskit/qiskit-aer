...
public:
  ...
  // Apply a 1-qubit matrix to the state vector.
  // The matrix is input as vector of the column-major vectorized 1-qubit matrix.
  void apply_matrix_mac(const uint_t qubit, const cvector_t<double> &mat);
 ...
 ******************************************************************************/
template <typename data_t>
void QubitVector<data_t>::apply_matrix_mac(const reg_t &qubits,
                                       const cvector_t<double> &mat) {
...
template <typename data_t>
void QubitVector<data_t>::apply_matrix_mac(const uint_t qubit,
                                       const cvector_t<double>& mat) {
