...
template <typename data_t, typename Derived>
void DensityMatrix<data_t, Derived>::apply_phase(const uint_t q, const complex_t &phase) {
...
template <typename data_t, typename Derived>
void DensityMatrix<data_t, Derived>::apply_cphase(const uint_t q0, const uint_t q1,
