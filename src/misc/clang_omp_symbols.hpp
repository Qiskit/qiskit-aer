...
extern "C" {
    ...
    WEAK void __kmpc_barrier(id* pId, int gtid){
    ...
    WEAK void __kmpc_for_static_fini(kmp_Ident *loc, int32_t global_tid){
    ...
    WEAK void __kmpc_for_static_init_4(kmp_Ident *loc, int32_t global_tid,
    ...
    WEAK void __kmpc_for_static_init_4u(kmp_Ident *loc, int32_t global_tid,
                                      int32_t sched, int32_t *plastiter,
    ...
    WEAK void __kmpc_for_static_init_8(kmp_Ident *loc, int32_t global_tid,
                                     int32_t sched, int32_t *plastiter,
    ...
    WEAK void __kmpc_for_static_init_8u(kmp_Ident *loc, int32_t global_tid,
    ...
    #include <stdarg.h>
    WEAK void __kmpc_fork_call(kmp_Ident *loc, int32_t argc, kmp_ParFctPtr microtask, ...){
        char variadic[4096];
        va_list argptr;
    ...
    WEAK void __kmpc_push_num_threads(kmp_Ident *loc, int32_t global_tid, int32_t num_threads){
    ...
    WEAK kmp_int32 __kmpc_reduce_nowait(
    ...
    WEAK void __kmpc_end_reduce_nowait(ident_t *loc, kmp_int32 global_tid, kmp_critical_name *lck){
    ...
    WEAK void __kmpc_serialized_parallel(kmp_Ident *loc, uint32_t global_tid){
    ...
    WEAK void __kmpc_end_serialized_parallel(ident_t *loc, kmp_int32 global_tid){
    ...
    WEAK int __kmpc_global_thread_num(id* pId){
        _hook__kmpc_global_thread_num(pId);
    }

    WEAK void __kmpc_dispatch_init_4(kmp_Ident *loc, int32_t global_tid,
                                   int32_t sched, int32_t lower, int32_t upper,
                                   int32_t incr, int32_t chunk); //{}
    WEAK void __kmpc_dispatch_init_4u(kmp_Ident *loc, int32_t global_tid,
                                    int32_t sched, uint32_t lower,
                                    uint32_t upper, int32_t incr,
                                    int32_t chunk); //{}
    WEAK void __kmpc_dispatch_init_8(kmp_Ident *loc, int32_t global_tid,
                                   int32_t sched, int64_t lower, int64_t upper,
                                   int64_t incr, int64_t chunk); //{}
    WEAK void __kmpc_dispatch_init_8u(kmp_Ident *loc, int32_t global_tid,
                                    int32_t sched, uint64_t lower,
                                    uint64_t upper, int64_t incr,
                                    int64_t chunk); //{}
    WEAK int __kmpc_dispatch_next_4(kmp_Ident *loc, int32_t global_tid,
                                  int32_t *plastiter, int32_t *plower,
                                  int32_t *pupper, int32_t *pstride); //{}
    WEAK int __kmpc_dispatch_next_4u(kmp_Ident *loc, int32_t global_tid,
                                   int32_t *plastiter, uint32_t *plower,
                                   uint32_t *pupper, int32_t *pstride); //{}
    WEAK int __kmpc_dispatch_next_8(kmp_Ident *loc, int32_t global_tid,
                                  int32_t *plastiter, int64_t *plower,
                                  int64_t *pupper, int64_t *pstride); //{}
    WEAK int __kmpc_dispatch_next_8u(kmp_Ident *loc, int32_t global_tid,
                                   int32_t *plastiter, uint64_t *plower,
                                   uint64_t *pupper, int64_t *pstride); //{}
    WEAK void __kmpc_dispatch_fini_4(kmp_Ident *loc, int32_t global_tid); //{}
    WEAK void __kmpc_dispatch_fini_4u(kmp_Ident *loc, int32_t global_tid); //{}
    WEAK void __kmpc_dispatch_fini_8(kmp_Ident *loc, int32_t global_tid); //{}
    WEAK void __kmpc_dispatch_fini_8u(kmp_Ident *loc, int32_t global_tid); //{}
    WEAK void __kmpc_for_static_init_4_simple_spmd(kmp_Ident *loc, int32_t global_tid,
                                          int32_t sched, int32_t *plastiter,
                                          int32_t *plower, int32_t *pupper,
                                          int32_t *pstride, int32_t incr,
                                          int32_t chunk); //{}
    WEAK void __kmpc_for_static_init_4u_simple_spmd(kmp_Ident *loc, int32_t global_tid,
                                           int32_t sched, int32_t *plastiter,
                                           uint32_t *plower, uint32_t *pupper,
                                           int32_t *pstride, int32_t incr,
                                           int32_t chunk); //{}
    WEAK void __kmpc_for_static_init_8_simple_spmd(kmp_Ident *loc, int32_t global_tid,
                                          int32_t sched, int32_t *plastiter,
                                          int64_t *plower, int64_t *pupper,
                                          int64_t *pstride, int64_t incr,
                                          int64_t chunk); //{}
    WEAK void __kmpc_for_static_init_8u_simple_spmd(kmp_Ident *loc, int32_t global_tid,
                                           int32_t sched, int32_t *plastiter1,
                                           uint64_t *plower, uint64_t *pupper,
                                           int64_t *pstride, int64_t incr,
                                           int64_t chunk); //{}
    WEAK void __kmpc_for_static_init_4_simple_generic(kmp_Ident *loc,
                                             int32_t global_tid, int32_t sched,
                                             int32_t *plastiter,
                                             int32_t *plower, int32_t *pupper,
                                             int32_t *pstride, int32_t incr,
                                             int32_t chunk); //{}
    WEAK void __kmpc_for_static_init_4u_simple_generic(
                                            ...
                                            int32_t chunk); //{}
    WEAK void __kmpc_for_static_init_8_simple_generic(kmp_Ident *loc,
                                             int32_t global_tid, int32_t sched,
                                             int32_t *plastiter,
                                             int64_t *plower, int64_t *pupper,
                                             int64_t *pstride, int64_t incr,
                                             int64_t chunk); //{}
    WEAK void __kmpc_for_static_init_8u_simple_generic(
    ...
    WEAK int __KAI_KMPC_CONVENTION omp_get_max_threads(void);
    WEAK void __KAI_KMPC_CONVENTION omp_set_nested(int foo);
}
