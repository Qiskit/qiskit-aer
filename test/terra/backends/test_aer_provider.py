...
class TestAerProvider(QiskitAerTestCase):
    ...
    def test_get_backend(self):
        ...
        circuit = transpile(QuantumVolume(4, 10, seed=0),
                    backend=backend,
    ...
    def test_backend_name_from_backend(self):
        """Test backend name of AerSimulator generated by from_backend."""
        backend = AerSimulator().from_backend(FakeMumbaiV2())
        self.assertEqual(backend.name, "aer_simulator_from(fake_mumbai)")
