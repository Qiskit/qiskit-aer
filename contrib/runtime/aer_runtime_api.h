...
// u3 gate
void aer_apply_u3(void *state, uint_t qubit, double theta, double phi,
                  double lambda);
...
// controlled-phase
void aer_apply_cp(void *state, uint_t ctrl_qubit, uint_t tgt_qubit,
                  double lambda);
// controlled-rx
void aer_apply_crx(void *state, uint_t ctrl_qubit, uint_t tgt_qubit,
                   double theta);
// controlled-ry
void aer_apply_cry(void *state, uint_t ctrl_qubit, uint_t tgt_qubit,
                   double theta);
// controlled-rz
void aer_apply_crz(void *state, uint_t ctrl_qubit, uint_t tgt_qubit,
                   double theta);
// controlled-H
...
// controlled-swap
void aer_apply_cswap(void *state, uint_t ctrl_qubit, uint_t qubit0,
                     uint_t qubit1);

// four parameter controlled-U gate with relative phase γ
void aer_apply_cu(void *state, uint_t ctrl_qubit, uint_t tgt_qubit,
