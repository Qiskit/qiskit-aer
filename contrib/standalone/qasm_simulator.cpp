...
int main(int argc, char **argv) {
  ...
  std::cerr << "The standalone simulator is deprecated as of Qiskit 0.14" << std::endl;
  std::cerr << "and will be removed no sooner than 3 months from that release." << std::endl;
  std::cerr << "Please run the simulator from Python script using AerSimulator.run()" << std::endl;
